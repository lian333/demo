  ...
  Future<void> _processFrame(CameraImage cameraFrame) async {
    ...
    try {
      ...
      final bytes = cameraFrame.planes[0].bytes;
       print(bytes);
      print('The format of the image is ${cameraFrame.format.group}');

      */
      int imageWidth = cameraFrame.width;
      int imageHeight = cameraFrame.height;
      int imageStride = cameraFrame.planes[0].bytesPerRow;
     ...
     final image = await createImage(data, imageWidth, imageHeight, ui.PixelFormat.rgba8888);
